...
separator.place(relx=0.5, rely=0, relwidth=0.009, relheight=1)
pos={}
funccheck=0
turn=1
validated=False
...
def writepos(pos1):
    with open('p1pos.dat','wb+') as f:
        pickle.dump(pos1,f)
    with open('p1pos.txt','w+') as f:
        f.write(f'{pos1}')
    #print(pos)
writepos(pos)
#defence
...
def muppet():
    ...
    for  j in range(200-20,700-50,50):
        ...
        c+=1
muppet()
#messagebox.showinfo('Place Ship','Place The 4 long ship')
#muppet(4)
#------------------------------------------------------------------------------------------------    
#offence
